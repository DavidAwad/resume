...
% \item{ \textbf{Bachelors of Science, Computer Science and Physics -- Rutgers University -- May 2016,  GPA: 2.9}}
\end{itemize}
...
% TODO add Lane Lines here

% TODO add tensorflow networks on here
...
\vspace{5pt}
\fi % these two projects are commented out
...
\item{\cventry{}{ \href{ }{Archangel Raphael's Mission}}{Co-Founder}{}{ { Technical Lead } }{I work as the technical lead of a small New Brunswick charity dedicated to creating community based outcome driven initiatives for the homeless population in Central New Jersey. }}
...
\item{\cventry{}{ Rutgers University Judo Club}{Public Relations Manager, Web Designer and Developer }{}{ {Managed and Improve the data, website, and social media of the Rutgers Judo Club.} }{}}
...
% \item{I have a huge interest in superconductors and  } 
