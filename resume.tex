...
\item{\cventry{May 2016 -- }{\href{http://armnewbrunswick.org/}{\color{link-accents}Archangel Raphael's Mission}}{Co-Founder and CTO}{New Brunswick}{}{
  \begin{itemize}
    ...
    \item{Responsible for creating a positive culture for our small team of developers and managing projects as we build out our online platform and internal tools primarily in Python.}
  \end{itemize}
}}
