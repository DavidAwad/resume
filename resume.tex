...
% set size for math ! 
%\DeclareMathSizes{<surrounding text size>}{<math text size>}{<math script size>}{<math script size>}
...
\item{\cventry{May 2016 -- November 2016}{\href{http://tumblr.com/}{Tumblr}}{Software Release Engineer}{New York City}{}{
\vspace{0pt}
I developed and maintained Tumblr internal deploy processes, developer build tools, source control wrappers, deploy reporting and statistics, and internal build group productivity tools. I Develop web based tools to report on build, branch, and project status for use by developers and product managers throughout the company. I worked with a lot of containerized services and deployments on Apache Mesos, using Docker and Python.  
}}

\item{\cventry{November 2015 -- }{\href{http://mlh.io/}{Major League Hacking}}{Hackathon Coach}{New York City}{}{
\vspace{0pt} 
I travel internationally to college student hackathons as an representative of Major League Hacking. This comes with a lot of experience giving both technical and nontechnical presentations to promote brand recognition and good outward facing public relations. I assist engineering students with rapidly prototyping their ideas and troubleshoot all kinds of different software and hardware projects at various events along with other engineers and developers from other companies across industry.
}}
...
% TODO add ARM to resume
\item{\cventry{September 2015 -- May 2016}{\href{http://codecademy.com/}{Codecademy}}{Codecademy Advisor}{New York city, Remotely}{}{
\vspace{0pt} 
Provided guidance and support for students first learning to code through the codecademy platform by helping them by work through potential errors in code as well as teaching anything from basic programming to computer science and data structures. Tracked issues and worked with product team for consistent improvement of product based on user feedback.
}}
